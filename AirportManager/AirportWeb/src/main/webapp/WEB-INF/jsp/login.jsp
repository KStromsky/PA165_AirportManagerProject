...
<jsp:attribute name="body"><%-- provide page-fragment attribute to be rendered by the my:layout tag --%>
    ...
    <form:form class="form-horizontal" role="form" method="post" modelAttribute="authSteward"  action="${pageContext.request.contextPath}/loged"
              >
            <div class="form-group">
                <label class="control-label col-sm-2" for="usernameInput">Username:</label>
                <div class="col-sm-10">
                    <form:input type="text" class="form-control" path="username" id="usernameInput" placeholder="Enter username"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <form:input type="password" path="pw" class="form-control" id="password" />
                    <form:errors path="pw" cssClass="help-block"/>
                </div>
            </div>
